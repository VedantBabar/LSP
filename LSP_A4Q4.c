// A4Q4 - Write a program which accept directory name from user and copy first 10 bytes from all regular files into newly created file named as Demo.txt.
...
int main(int argc, char * argv[])
{
    ...
    if(entry != NULL)
    {
        printf("Error : unable to open some file\n");  
    }
